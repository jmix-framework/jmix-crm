// PROJECT override of the standard script: studio-templates/script/descriptorFileName.groovy
// Adds the 'crm-' prefix so that it is obvious the project version is used.
...
StringBuilder result = new StringBuilder("crm-")
