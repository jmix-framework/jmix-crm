...
class CrmAnalyticsServiceLLMTest extends AbstractTest {
    ...
    class CoreMetrics {
        ...
        void testClientCountQuestion() {
            ...
            llmJudge.evaluateAnwserWithJudge(question, response, actualClientCount + " clients");
        }
        ...
        void testTopClientQuestion() {
            ...
            llmJudge.evaluateAnwserWithJudge(question, response, topClientName + " with " + topClientRevenue + " revenue");
        }
        ...
        void testOrderCountQuestion() {
            ...
            llmJudge.evaluateAnwserWithJudge(question, response, actualOrderCount + " orders");
        }
        ...
        void testAverageOrderValueQuestion() {
            ...
            llmJudge.evaluateAnwserWithJudge(question, response, actualAverageOrderValue.toString());
        }
    }
    ...
    class ClientValueAnalysis {
        ...
        void testClientSegmentationQuestion() {
            ...
            llmJudge.evaluateAnwserWithJudge(question, response, expectedAnswer);
        }
