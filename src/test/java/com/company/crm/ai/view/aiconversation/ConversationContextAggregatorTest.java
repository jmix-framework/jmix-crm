...
class ConversationContextAggregatorTest {
    ...
    void aggregatesEntityReferencesAndSeparatesAttachmentsByType() {
        ...
        message.setAttachments(List.of(
                newAttachment("ai.csv", AiAttachmentType.AI_GENERATED),
                newAttachment("user.pdf", AiAttachmentType.USER_UPLOADED)
        ));
    ...
    void messagesAreSortedByCreatedDateBeforeAggregation() {
        ...
        olderMessage.setAttachments(List.of(newAttachment("a.csv", AiAttachmentType.AI_GENERATED)));
        ChatMessage newerMessage = newMessage(later);
        newerMessage.setAttachments(List.of(newAttachment("b.csv", AiAttachmentType.AI_GENERATED)));
    ...
    private AiConversationAttachment newAttachment(String fileName, AiAttachmentType type) {
