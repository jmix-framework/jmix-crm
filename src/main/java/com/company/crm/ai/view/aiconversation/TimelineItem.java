...
class TimelineItem {
    ...
    static TimelineItem user(ChatMessage message) {
        return new TimelineItem(TimelineItemKind.USER, message, List.of());
    }

    static TimelineItem assistant(ChatMessage message) {
        return new TimelineItem(TimelineItemKind.ASSISTANT, message, List.of());
    }

    static TimelineItem thinking(ChatMessage placeholder) {
    ...
    List<AiUiStatusUpdate> statusUpdates() {
