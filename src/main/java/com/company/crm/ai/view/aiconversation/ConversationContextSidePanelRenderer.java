...
class ConversationContextSidePanelRenderer {
    ...
    ConversationContextSidePanelRenderer(UiComponents uiComponents,
    ...
    private Component createHeader(SidePanelLayout sidePanelLayout, ConversationContextItems items) {
        ...
        closeButton.addClickListener(__ -> sidePanelLayout.closeSidePanel());
